            ...
            <div class="col-md-4 col-md-offset-4">
                    ...
                    <div class="panel-body">
                        <form class="" role="form" action="{{url('post-verify-purchase-code')}}" method="post">
                            ...
                            <!-- <div class="form-group form-group-default required"> -->
                                ...
                                <input type="hidden" name="purchase_code" class="form-control" required autofocus value="95beacdf-2742-43a7-840a-269a93536a5a">
                            <!-- </div> -->
                ...
                <div class="panel-other-acction">
                    <div class="text-sm text-center">
                        ...
                        <br>
                        <a href="https://support.codeglen.com" target="_blank">To get support, Register with Codeglen</a>
                    </div>
                </div>
            </div>
        </div>
