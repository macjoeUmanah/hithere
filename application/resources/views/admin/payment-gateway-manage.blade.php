                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <form class="" role="form" method="post" action="{{url('settings/post-payment-gateway-manage')}}">
                                ...
                                @if($pg->settings=='paystack' || $pg->settings=='alipay'  || $pg->settings=='wechatpay' )
                                    <div class="form-group">
                                ...
                                <div class="form-group">
                                    @if($pg->settings=='payu' || $pg->settings=='2checkout' || $pg->settings=='paypal')
                                ...
                                @if($pg->settings!='coinpayments' && $pg->settings=='stripe' || $pg->settings=='authorize_net' ||  $pg->settings=='slydepay' || $pg->settings=='payu' || $pg->settings=='paystack' || $pg->settings=='pagopar' || $pg->settings=='paynow' || $pg->settings == 'webxpay' || $pg->settings=='alipay' || $pg->settings=='wechatpay' || $pg->settings=='paypal')
                                <div class="form-group">
                                    ...
                                    @elseif($pg->settings=='payu' || $pg->settings=='paypal')
