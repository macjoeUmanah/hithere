                                ...
                                <div class="panel">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        @endif
                                            ...
                                            @if($gateway->settings!='Twilio' && $gateway->settings!='Signalwire' && $gateway->settings!='Zang' && $gateway->settings!='Plivo' && $gateway->settings!='AmazonSNS' && $gateway->settings!='TeleSign' && $gateway->settings!='BSG' && $gateway->settings!='TwilioCopilot')
                                                <div class="form-group">
                                            ...
                                            @if($gateway->settings!='Twilio' && $gateway->settings=='Signalwire' && $gateway->settings!='Zang' && $gateway->settings!='Plivo' && $gateway->settings!='AmazonSNS' && $gateway->settings!='TeleSign' && $gateway->settings!='BSG' && $gateway->settings!='TwilioCopilot')
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="gateway_ids">{{$gateway->gateway_ids}}</textarea>
                                                </div>
                                            @endif
                                            @if($gateway->settings=='Asterisk' || $gateway->settings=='JasminSMS' || $gateway->settings=='Diafaan' || $gateway->type=='smpp')
                                                <div class="form-group">
                                                    <label>Port</label>
                                            ...
                                            @foreach($credentials as $credential)
                                                ...
                                                @if($gateway->settings!='MessageBird' && $gateway->settings!='SmsGatewayMe' && $gateway->settings!='Clickatell_Touch' && $gateway->settings!='Tropo' && $gateway->settings!='SmsBump' && $gateway->settings!='BSG' && $gateway->settings!='Beepsend' && $gateway->settings!='TigoBeekun' && $gateway->settings!='Easy' && $gateway->settings!='CMSMS' && $gateway->settings != 'Mailjet' && $gateway->settings != 'ClxnetworksHTTPRest' && $gateway->settings != 'MaskSMS' && $gateway->settings!='WhatsAppChatApi' && $gateway->settings!='Gatewayapi' && $gateway->settings!='MessageWhiz')
                                                    <td>
                                                        ...
                                                        <div class="form-group">
                                                            <label>
                                                                @if($gateway->settings=='Twilio' || $gateway->settings=='Zang' || $gateway->settings=='Plivo' || $gateway->settings=='Signalwire')
                                                                    {{language_data('Auth Token')}}
                                                                @elseif($gateway->settings=='SMSKaufen' || $gateway->settings=='NibsSMS' || $gateway->settings=='LightSMS' || $gateway->settings=='Wavecell' || $gateway->settings == 'ClickSend')
