<?php $__env->startSection('style'); ?>
    <?php echo Html::style("assets/css/chat-application.css"); ?>

    <?php echo Html::style("assets/libs/perfect-scrollbar/perfect-scrollbar.css"); ?>
        ...
        <div class="row">
            <div class="col-md-12 p-lr-0">
                <div class="page-title-area clearfix">
                    <h2 class="page-title pull-left"><?php echo e(language_data('Chat SMS')); ?></h2>
                </div>
            </div>
        </div>
        <!-- Left Sidebar -->
                ...
                <div class="sidebar-content d-lg-block">
                    <div class="chart-body chat-fixed-search">
                        <fieldset class="form-group position-relative">
                            <input type="text" class="form-control search-query" id="iconLeft4" placeholder="<?php echo e(language_data('Search')); ?>">
                    ...
                    <div id="users-list" class="list-group position-relative sms_history">
                        <div class="users-list-padding member_list"  id="sms-history-data">
                            <?php echo $__env->make('admin.get-chat-box', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        </div>

                        <?php if($sms_count > 15): ?>
                            <div class="load_div">
                                <a href="#" class="btn btn-success btn-xs" id="load_more"><?php echo e(language_data('Load More')); ?></a>
                            </div>
                        <?php endif; ?>
                            ...
                            <form method="POST" action="#" id="ReplySMS">
                                <div class="col-md-9">
                                    <div class="form-group">
                                        <textarea class="form-control" placeholder="<?php echo e(language_data('Type your message')); ?>" name="message"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    ...
                                    <a href="#" class="btn btn-complete blacklist-btn" data-toggle="tooltip" data-placement="top"
                                       title="<?php echo e(language_data('Add To Blacklist')); ?>"> <i class="fa fa-user-md d-lg-none"></i>
                                    </a>

                                    <a href="#" class="btn btn-danger remove-btn" data-toggle="tooltip" data-placement="top"
                                       title="<?php echo e(language_data('Remove History')); ?>"> <i class="fa fa-trash d-lg-none"></i>
                                    </a>
                                </div>
                            </form>
                        </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <?php echo Html::script("assets/libs/perfect-scrollbar/perfect-scrollbar.js"); ?>

    <?php echo Html::script("assets/js/jscroll.js"); ?>
