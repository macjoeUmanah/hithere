                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div id="send-sms-file-wrapper">
                                <form class="" id="send-sms-file-form" role="form" method="post" action="<?php echo e(url('sms/post-import-file-contact')); ?>" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group input-group input-group-file">
                                            <span class="input-group-btn">
                                                <span class="btn btn-primary btn-file">
                                                    <?php echo e(language_data('Browse')); ?> <input type="file" class="form-control" name="import_numbers" @change="handleImportNumbers">
                                                </span>
                                            </span>
                                    ...
                                    <button type="submit" id="submitContact" class="btn btn-success btn-sm pull-right"><i class="fa fa-plus"></i> <?php echo e(language_data('Add')); ?> </button>
                                </form>
                            </div>
                        </div>
                    </div>
