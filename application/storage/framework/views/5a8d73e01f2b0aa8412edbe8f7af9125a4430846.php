                            ...
                            <form class="" role="form" action="<?php echo e(url('administrators/update-admin-set-roles')); ?>" method="post">
                                ...
                                <div class="form-group">
                                    <div class="coder-checkbox">
                                        ...
                                        <span class="co-check-ui"></span>
                                        <label><?php echo e(language_data('Send Quick SMS')); ?></label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="coder-checkbox">
                                        <input type="checkbox" <?php if(permission($admin_roles->id,38)): ?> checked <?php endif; ?> name="perms[]" value="38">
                                        <span class="co-check-ui"></span>
                                        <label><?php echo e(language_data('Price Bundles')); ?></label>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <div class="coder-checkbox">
                                        <input type="checkbox" <?php if(permission($admin_roles->id,39)): ?> checked <?php endif; ?> name="perms[]" value="39">
                                        <span class="co-check-ui"></span>
                                        <label><?php echo e(language_data('Price Bundles')); ?></label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="coder-checkbox">
                                        <input type="checkbox" <?php if(permission($admin_roles->id,40)): ?> checked <?php endif; ?> name="perms[]" value="40">
                                        <span class="co-check-ui"></span>
                                        <label><?php echo e(language_data('Import Contacts')); ?></label>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <div class="coder-checkbox">
                                        <input type="checkbox" <?php if(permission($admin_roles->id,41)): ?> checked <?php endif; ?> name="perms[]" value="41">
                                        <span class="co-check-ui"></span>
                                ...
                                <div class="form-group">
                                    <div class="coder-checkbox">
                                        <input type="checkbox" <?php if(permission($admin_roles->id,42)): ?> checked <?php endif; ?> name="perms[]" value="42">
                                        <span class="co-check-ui"></span>
                                        <label><?php echo e(language_data('Blacklist Contacts')); ?></label>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <div class="coder-checkbox">
                                        <input type="checkbox" <?php if(permission($admin_roles->id,43)): ?> checked <?php endif; ?> name="perms[]" value="43">
                                        <span class="co-check-ui"></span>
                                        <label><?php echo e(language_data('Block Message')); ?></label>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <div class="coder-checkbox">
                                        <input type="checkbox" <?php if(permission($admin_roles->id,44)): ?> checked <?php endif; ?> name="perms[]" value="44">
                                        <span class="co-check-ui"></span>
                                        <label><?php echo e(language_data('Recurring SMS')); ?></label>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <div class="coder-checkbox">
                                        <input type="checkbox" <?php if(permission($admin_roles->id,45)): ?> checked <?php endif; ?> name="perms[]" value="45">
                                        <span class="co-check-ui"></span>
                                        <label><?php echo e(language_data('Send')); ?> <?php echo e(language_data('Recurring SMS')); ?></label>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <div class="coder-checkbox">
                                        <input type="checkbox" <?php if(permission($admin_roles->id,46)): ?> checked <?php endif; ?> name="perms[]" value="46">
                                        <span class="co-check-ui"></span>
                                        <label><?php echo e(language_data('Send Recurring SMS File')); ?></label>
                                    </div>
                                </div>
