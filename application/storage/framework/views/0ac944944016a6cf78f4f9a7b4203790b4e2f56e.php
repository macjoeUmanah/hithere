                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            <label for="el3"><?php echo e(language_data('Direction')); ?></label>
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            <label for="el3"><?php echo e(language_data('From')); ?></label>
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            <label for="el3"><?php echo e(language_data('To')); ?></label>
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            <label for="el3"><?php echo e(language_data('Status')); ?></label>
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            <label for="el2"><?php echo e(language_data('Date')); ?> <?php echo e(language_data('From')); ?></label>
                                    ...
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            <label for="el2"><?php echo e(language_data('Date')); ?> <?php echo e(language_data('To')); ?></label>
        ...
        $(document).ready(function(){
          ...
          $("#date_to").on("dp.change", function (e) {
            ...
            var oTable = $('.data-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '<?php echo url('sms/get-sms-history-data/'); ?>',
                    data: function (d) {
           ...
           deleteTriger.hide();
            ...
            deleteTriger.on("click", function(event){ // triggering delete one by one
                if( $('.deleteRow:checked').length > 0 ){  // at-least one checkbox checked
                    ...
                    $.ajax({
                        type: "POST",
                        url: '<?php echo url('/sms/bulk-sms-delete/'); ?>',
          ...
          $('table').delegate('.reply_message', 'click', function (e) {
            ...
            var id = this.id;
            bootbox.prompt({
              title: "<?php echo language_data('Reply Message'); ?>",
              inputType: 'textarea',
