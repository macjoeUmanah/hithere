                ...
                <div class="col-lg-5">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <form class="" role="form" method="post" action="<?php echo e(url('sms/post-blacklist-contact')); ?>">
                        ...
                        <div class="panel-body p-none">
                            <table class="table data-table table-hover">
                                ...
                                <tr>
                                    ...
                                    <th style="width: 60%"><?php echo e(language_data('Numbers')); ?></th>
    ...
    <script>
        $(document).ready(function(){
            ...
            var oTable =  $('.data-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '<?php echo url('sms/get-blacklist-contact/'); ?>',
                columns: [
            ...
            deleteTriger.on("click", function(event){ // triggering delete one by one
                if( $('.deleteRow:checked').length > 0 ){  // at-least one checkbox checked
                    ...
                    $.ajax({
                        type: "POST",
                        url: '<?php echo url('/sms/delete-bulk-blacklist-contact/'); ?>',
