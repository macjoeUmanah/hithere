...
<?php $__env->startSection('content'); ?>
    ...
    <section class="wrapper-bottom-sec">
        <div class="p-30 clearfix">
            ...
            <a href="<?php echo e(url('sms/create-sms-template')); ?>" class="btn btn-success btn-sm pull-right"><i class="fa fa-plus"></i> <?php echo e(language_data('Create Template')); ?></a>
        </div>
                        ...
                        <div class="panel-body p-none">
                            <table class="table data-table table-hover">
                                ...
                                <tr>
                                    ...
                                    <th style="width: 10%;"><?php echo e(language_data('Global')); ?></th>
                                ...
                                <?php $__currentLoopData = $sms_templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $st): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td data-label="Actions">
                                            <a class="btn btn-success btn-xs" href="<?php echo e(url('sms/manage-sms-template/'.$st->id)); ?>" ><i class="fa fa-edit"></i> <?php echo e(language_data('Manage')); ?></a>
