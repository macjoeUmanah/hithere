                    ...
                    <div class="panel-body">
                        ...
                        <form class="" role="form" method="post" action="<?php echo e(url('user/post-registration')); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" required name="first_name" id="first_name" value="<?php echo e(old('first_name')); ?>">
                            </div>

                            <div class="form-group">
                                <label><?php echo e(language_data('Last Name')); ?></label>
                                <input type="text" class="form-control" name="last_name" placeholder="Optional"  value="<?php echo e(old('last_name')); ?>">
                            </div>

                            <div class="form-group">
                                <label><?php echo e(language_data('Email')); ?></label>
                                <input type="email" class="form-control" name="email" placeholder="email address" required  value="<?php echo e(old('email')); ?>">
                            </div>
