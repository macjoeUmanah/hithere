<?php $__env->startSection('content'); ?>
    ...
    <section class="wrapper-bottom-sec">
        <div class="p-30">
            <h2 class="page-title"><?php echo e(language_data('Manage SMS Template')); ?></h2>
        </div>
                ...
                <div class="col-lg-6">
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title"><?php echo e(language_data('Manage SMS Template')); ?></h3>
                        </div>
                        <div class="panel-body">
                            <form class="" role="form" action="<?php echo e(url('sms/post-manage-sms-template')); ?>" method="post">


                                <div class="form-group">
                                    <label><?php echo e(language_data('Template Name')); ?></label>
                                    <input type="text" class="form-control" required name="template_name" value="<?php echo e($st->template_name); ?>"/>
                                </div>

                                <div class="form-group">
                                    <label><?php echo e(language_data('From')); ?></label>
                                    <input type="text" class="form-control" name="from" value="<?php echo e($st->from); ?>"/>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control selectpicker" name="status">
                                        <option value="active" <?php if($st->status=='active'): ?> selected <?php endif; ?>><?php echo e(language_data('Active')); ?></option>
                                        <option value="inactive"  <?php if($st->status=='inactive'): ?> selected <?php endif; ?>><?php echo e(language_data('Inactive')); ?></option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="message" name="message" rows="8"><?php echo e($st->message); ?></textarea>
                                </div>

                                <div class="form-group">
                                    <div class="coder-checkbox">
                                        <input type="checkbox" <?php if($st->global=='yes'): ?> checked <?php endif; ?> value="yes" name="set_global">
                                        <span class="co-check-ui"></span>
                                        <label><?php echo e(language_data('Set as Global')); ?></label>
                                    </div>
                                </div>
